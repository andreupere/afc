...
public class PaymentTTPServer extends Server {
	
	private String keyCertPassword;
	private GeneralConfigXML gConfig;

	public PaymentTTPServer(Integer port, String keyCertPassword) {
		super(port);
	...
	public void listen() throws IOException {
		...
		while (_listening) {
			...
			new PaymentTTPServerThread(socket, gConfig).run();
		}
	}
	...
	public static void main(String[] args) {
		...
		PaymentTTPServer s = new PaymentTTPServer(port, keyCertPassword);
		try {
